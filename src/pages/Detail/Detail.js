                ...
                <div className="grid grid-cols-12">
                    <div className="col-span-5 col-start-3">
                        <div className="grid grid-cols-3">
                            <img className="col-span-1" src={filmDetail.hinhAnh} style={{ width: '100%', height: 300 }} />
                            <div className="col-span-2 ml-5" style={{ marginTop: '25%' }}>
                                ...
                                <p className="text-3xl leading-3 text-black">{filmDetail.tenPhim}</p>
                                <p>{filmDetail.moTa}</p>
                            </div>
                        </div>
                    ...
                    <div className="col-span-4">
                        <h1 style={{ marginLeft: '15%', color: 'blue', fontWeight: 'bold', fontSize: 15 }}>Đánh giá</h1>
                                    ...
                                    {filmDetail.heThongRapChieu?.map((htr, index) => {
                                        return <TabPane
                                            tab={<div className="flex flex-row items-center justify-center">
                                                <img src={htr.logo} style={{width:50}} className="rounded-full w-full"  />
